...
struct MyMeshView: View {
    ...
    var animation : Animation {
        Animation
            .interactiveSpring(duration: durration)
    ...
    var body: some View {
        mesh
            ...
            .onReceive(timer){_ in
                RandomisePointsAndColor()
            }
    }
    func RandomisePointsAndColor(){
        ...
        background = someColors.randomElement() ?? .indigo
    }
}
